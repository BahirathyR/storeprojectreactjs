...
class EmployeeDetails extends React.Component {
  ...
  updateUser = async (initialValues) => {
    ...
    const data = {
      _id: this.state.id,
      empId: this.state.initialValues.EmpId,
      ...
      dob: this.state.initialValues.dob,
      designation: this.state.initialValues.course,
      companyName: this.state.initialValues.companyName,
    };
      ...
      <Formik
        ...
        render={({ errors, touched, values, handleChange }) => (
          <Container>
            ...
            {this.state.isEdit ? (
              <EditEmployee edituser={this.state.edituser} />
            ) : (
              <Form>
                <Row>
                  <Col>
